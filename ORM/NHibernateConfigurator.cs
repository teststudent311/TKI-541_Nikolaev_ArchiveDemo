...
namespace ORM
{
    ...
    /// <summary>
    /// Конфигуратор для создания фабрики сессий NHibernate.
    /// </summary>
    public static class NHibernateConfigurator
    {
        ...
        private static FluentConfiguration GetConfiguration(Assembly assembly = null, bool showSql = false)
        {
            ...
            {
                var databaseConfiguration = PostgreSQLConfiguration.Standard
                    .ConnectionString("Host=localhost;Username=postgres;Password=;Database=test_bd;");
